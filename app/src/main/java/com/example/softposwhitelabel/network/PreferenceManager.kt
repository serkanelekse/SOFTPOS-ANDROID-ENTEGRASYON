...
open class PreferenceManager constructor(context: Context) : IPreferenceHelper {
    ...
    private val PREFS_NAME = "com.elekse.softposwhitelabel"
    private var preferences: SharedPreferences

    companion object {
        const val TOKEN = "token"
        const val USER_ID = "userId"
        const val DEALER_ID = "dealerId"
    }
    ...
    override fun setDealerId(dealerId: String) {
        try {
            preferences[DEALER_ID] = dealerId
        } catch (e: Exception) {
            //  Firebase.crashlytics.recordException(e)
        }
    }

    override fun getDealerId(): String {
        return try {
